<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"C:\wamp64\www\pay/app/admin\view\order.index.html";i:1531455598;s:51:"C:\wamp64\www\pay\app\extra\view\admin.content.html";i:1531455603;}*/ ?>
<div class="ibox">
...
<form onsubmit="return false;" data-auto="true" method="post">
    ...
    <table class="layui-table" lay-skin="line" lay-size="sm">
        ...
        <tr>
			...
			<td class='text-center'><?php echo $vo['notifyUrl']; ?></td>
            ...
            <td class="text-center nowrap"><?php echo format_time($vo['cTime']); ?></td>
