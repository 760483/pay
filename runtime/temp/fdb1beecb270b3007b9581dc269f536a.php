<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:55:"C:\wamp64\www\pay/app/admin\view\mer_channel.index.html";i:1527065537;s:51:"C:\wamp64\www\pay\app\extra\view\admin.content.html";i:1526461055;}*/ ?>
<div class="ibox">
    ...
    <table class="layui-table" lay-skin="line" lay-size="sm">
        ...
        <tr>
		  ...
		  <th class='list-table-check-td'>
            ...
            <td class='text-center'><?php echo $vo['mParentId']; ?></td>
            <td class='text-center'><?php echo $vo['mUId']; ?></td>
			...
			<td class="text-center nowrap"><?php echo $vo['mName']; ?></td>
			<td class="text-center nowrap"><?php echo $vo['mKey']; ?></td>
			<td class="text-center nowrap"><?php echo $vo['mRate']; ?></td>
			<td class="text-center nowrap"><?php echo $vo['mStatus']; ?></td>
			<td class="text-center nowrap"><?php echo $vo['cName']; ?></td>
            <td class='text-center nowrap'>
                ...
                <span class="text-explode">|</span>
                <a data-open='<?php echo url("$classuri/apply"); ?>?id=<?php echo $vo['mId']; ?>' href="javascript:void(0)">授权</a>
