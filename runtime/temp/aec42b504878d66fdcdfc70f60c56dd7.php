<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:49:"C:\wamp64\www\pay/app/wechat\view\fans.index.html";i:1531474555;s:51:"C:\wamp64\www\pay\app\extra\view\admin.content.html";i:1531474545;}*/ ?>
<div class="ibox">
...
<div class="nowrap pull-right" style="margin-top:10px;">
    <button data-update="" data-action="<?php echo url('backadd'); ?>" class='layui-btn layui-btn-small'><i class='fa fa-ban'></i>
        移入黑名单
    </button>
</div>

<div class="nowrap pull-right" style="margin-top:10px;margin-right:10px;">
    <button data-load="<?php echo url('sync'); ?>" class='layui-btn layui-btn-small'><i class="fa fa-skyatlas"></i> 同步粉丝</button>
</div>
    ...
    <div class="row">
        <div class="col-xs-2">
            <div class="form-group">
                <input type="text" name="nickname" value="<?php echo (\think\Request::instance()->get('nickname') ?: ''); ?>" placeholder="昵称"
        ...
        <div class="col-xs-1">
            <div class="form-group">
                <input type="text" name="country" value="<?php echo (\think\Request::instance()->get('country') ?: ''); ?>" placeholder="国家"
                       class="input-sm form-control">
            </div>
        </div>
        ...
        <div class="col-xs-1">
            <div class="form-group">
                <input type="text" name="province" value="<?php echo (\think\Request::instance()->get('province') ?: ''); ?>" placeholder="省份"
                       class="input-sm form-control">
            </div>
        </div>
        ...
        <div class="col-xs-1">
            <div class="form-group">
                <input type="text" name="city" value="<?php echo (\think\Request::instance()->get('city') ?: ''); ?>" placeholder="城市"
                       class="input-sm form-control">
            </div>
        </div>
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <td class='text-center'>
                <img style="width:25px;height:25px;border-radius:50%;margin-right:10px" data-tips-image
                     src="<?php echo $vo['headimgurl']; ?>"/>
                <?php echo (isset($vo['nickname']) && ($vo['nickname'] !== '')?$vo['nickname']:"<span style='color:#999'>未设置微信昵称</span>"); ?>
            </td>
            <td class='text-center'><?php echo (isset($vo['openid']) && ($vo['openid'] !== '')?$vo['openid']:"<span style='color:#ccc'>未知</span>"); ?></td>
            <td class='text-center'><?php echo $vo['sex']==1?'男':($vo['sex']==2?'女':'未知'); ?></td>
            <td>
                    <span>
                        <a data-add-tag='<?php echo $vo['id']; ?>' data-used-id='<?php echo join(",",array_keys($vo['tags_list'])); ?>'
                           id="tag-fans-<?php echo $vo['id']; ?>" href='javascript:void(0)'
            ...
            <td class='text-center'><?php echo (isset($vo['country']) && ($vo['country'] !== '')?$vo['country']:'<span style="color:#999">未设置区域信息</span>'); ?><?php echo $vo['province']; ?><?php echo $vo['city']; ?>
            </td>
