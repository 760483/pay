<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:53:"C:\wamp64\www\pay/app/admin\view\merchannel.form.html";i:1527131038;}*/ ?>
<form class="layui-form layui-box" style='padding:25px 30px 20px 0' action="__SELF__" data-auto="true" method="post">
	...
	<div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="status" value='<?php echo (isset($vo['status']) && ($vo['status'] !== '')?$vo['status']:""); ?>' required="required" title="status" placeholder="status" class="layui-input">
        </div>
    </div>
