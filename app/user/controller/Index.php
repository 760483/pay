...
class Index  extends Common{
	...
	public function index(){
		...
		if(!session("?UserName") || !session("?UserType") || !session("?UserID")){
            ...
            $Money = db("Money");
            $Money_Money =  $Money->where("UserID=".session("UserID"))->value("Money");
            
            $Userbasicinformation =db("Userbasicinformation");
            $Compellation = $Userbasicinformation->where("UserId=".session("UserID"))->value("Compellation");
          
            $Userapiinformation =db("Userapiinformation");
            $zt = $Userapiinformation->where("UserId=".session("UserID"))->value("Zt");
            
            if(!session("?scdate")){
                
                $Dldate =db("Dldate");
                
                $dldldate = $Dldate->where("UserID=".session("UserID"))->order("dldate desc")->value("dldate");
                $dldlip = $Dldate->where("UserID=".session("UserID"))->order("dldate desc")->value("ip");  
            ...
            $BankName = $Bank->where("UserID=".session("UserID")." and moren = 1")->value("BankName");
    ...
    public function sjtggshow(){
         $id = $this->_get("newsid");
          ...
          $datetime = $Newlist->where("id=".$id)->value("datetime");
    ...
    public function shtd(){   //商户通道首页
       ...
       // $list = $Userapiinformation->where("UserID=".session("UserID"))->select();
        $User =db("User");
        $tongdao = $User->where("id=".session("UserID"))->value("tongdao");
        $sjapi =db("Sjapi");
    ...
    public function sqtjl(){
        ...
        $tjlnf = $Tkconfig->where("UserID=0")->value("tjlnf");
    ...
    public function sqtjlok(){  //确认开通T+0
        ...
        $tjlnf = $Tkconfig->where("UserID=0")->value("tjlnf");  //T+0年费
        
        $Money =db("Money");
        
        $Money_Money =  $Money->where("UserID=".session("UserID"))->value("Money");  //商户账户余额
        ...
        $PayPassWord = $Usersafetyinformation->where("UserID=".session("UserID"))->value("PayPassWord");
    ...
    */
    ...
    header("Content-Type:text/html; charset=utf-8");
        $Userapiinformation =db("Userapiinformation");
        ////////////////////////////////////////////////////////////////////
          $WebsiteUrl = $Userapiinformation->where("UserID=".session("UserID"))->value("WebsiteUrl");
           $CompanyName = $Userapiinformation->where("UserID=".session("UserID"))->value("CompanyName");
           $WebsiteName = $Userapiinformation->where("UserID=".session("UserID"))->value("WebsiteName");
           $IdentificationFront = $Userapiinformation->where("UserID=".session("UserID"))->value("IdentificationFront"); 
           $IdentificationReverse = $Userapiinformation->where("UserID=".session("UserID"))->value("IdentificationReverse");
           $BusinessLicense = $Userapiinformation->where("UserID=".session("UserID"))->value("BusinessLicense");
    ...
    public function shjkshtg(){  //审核通过
           ...
           $CompanyName = $Userapiinformation->where("UserID=".$this->_post("UserID"))->value("CompanyName");
           $WebsiteName = $Userapiinformation->where("UserID=".$this->_post("UserID"))->value("WebsiteName");
           $IdentificationFront = $Userapiinformation->where("UserID=".$this->_post("UserID"))->value("IdentificationFront"); 
           $IdentificationReverse = $Userapiinformation->where("UserID=".$this->_post("UserID"))->value("IdentificationReverse");
           $BusinessLicense = $Userapiinformation->where("UserID=".$this->_post("UserID"))->value("BusinessLicense");
    ...
    public function chongzhi(){     //平台冲值
        ...
        $Userapiinformation =db("Userapiinformation");
    $Sjt_Key = $Userapiinformation->where("UserID=".session("UserID"))->value("Key");
    ...
    $Userapiinformation =db("Userapiinformation");
    $key = $Userapiinformation->where("UserID=".$Sjt_MerchantID)->value("Key");
    ...
    public function returnurl(){
        ...
        $Sjt_Sign = $_REQUEST["Sjt_Sign"];
         $Sjt_BType = $_REQUEST["Sjt_BType"];
        $Userapiinformation =db("Userapiinformation");
        $key = $Userapiinformation->where("UserID=".session("UserID"))->value("Key");
    ...
    public function mbk(){
        ...
        $mbk = $User->where("id=".session("UserID"))->value("mbk");
        
        $Passwordblock =db("Passwordblock");
        ...
        $A1 = $Passwordblock->where("UserID=".session("UserID"))->value("A1");
    ...
    /////////////////////////////////////////////////////////////
    ImageTTFText($im,20,0,60,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A1"));
    ImageTTFText($im,20,0,110,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B1"));
    ImageTTFText($im,20,0,160,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C1"));
    ImageTTFText($im,20,0,210,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D1"));
    ImageTTFText($im,20,0,260,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E1"));
    ImageTTFText($im,20,0,310,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F1"));
    ImageTTFText($im,20,0,360,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G1"));
    ImageTTFText($im,20,0,410,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H1"));
    ImageTTFText($im,20,0,460,85,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I1"));
    
    ImageTTFText($im,20,0,60,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A2"));
    ImageTTFText($im,20,0,110,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B2"));
    ImageTTFText($im,20,0,160,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C2"));
    ImageTTFText($im,20,0,210,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D2"));
    ImageTTFText($im,20,0,260,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E2"));
    ImageTTFText($im,20,0,310,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F2"));
    ImageTTFText($im,20,0,360,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G2"));
    ImageTTFText($im,20,0,410,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H2"));
    ImageTTFText($im,20,0,460,135,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I2"));
    
    ImageTTFText($im,20,0,60,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A3"));
    ImageTTFText($im,20,0,110,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B3"));
    ImageTTFText($im,20,0,160,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C3"));
    ImageTTFText($im,20,0,210,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D3"));
    ImageTTFText($im,20,0,260,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E3"));
    ImageTTFText($im,20,0,310,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F3"));
    ImageTTFText($im,20,0,360,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G3"));
    ImageTTFText($im,20,0,410,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H3"));
    ImageTTFText($im,20,0,460,185,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I3"));
    
    ImageTTFText($im,20,0,60,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A4"));
    ImageTTFText($im,20,0,110,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B4"));
    ImageTTFText($im,20,0,160,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C4"));
    ImageTTFText($im,20,0,210,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D4"));
    ImageTTFText($im,20,0,260,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E4"));
    ImageTTFText($im,20,0,310,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F4"));
    ImageTTFText($im,20,0,360,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G4"));
    ImageTTFText($im,20,0,410,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H4"));
    ImageTTFText($im,20,0,460,235,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I4"));
    
    ImageTTFText($im,20,0,60,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A5"));
    ImageTTFText($im,20,0,110,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B5"));
    ImageTTFText($im,20,0,160,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C5"));
    ImageTTFText($im,20,0,210,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D5"));
    ImageTTFText($im,20,0,260,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E5"));
    ImageTTFText($im,20,0,310,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F5"));
    ImageTTFText($im,20,0,360,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G5"));
    ImageTTFText($im,20,0,410,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H5"));
    ImageTTFText($im,20,0,460,285,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I5"));
    
    ImageTTFText($im,20,0,60,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A6"));
    ImageTTFText($im,20,0,110,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B6"));
    ImageTTFText($im,20,0,160,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C6"));
    ImageTTFText($im,20,0,210,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D6"));
    ImageTTFText($im,20,0,260,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E6"));
    ImageTTFText($im,20,0,310,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F6"));
    ImageTTFText($im,20,0,360,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G6"));
    ImageTTFText($im,20,0,410,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H6"));
    ImageTTFText($im,20,0,460,335,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I6"));
    
    ImageTTFText($im,20,0,60,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A7"));
    ImageTTFText($im,20,0,110,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B7"));
    ImageTTFText($im,20,0,160,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C7"));
    ImageTTFText($im,20,0,210,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D7"));
    ImageTTFText($im,20,0,260,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E7"));
    ImageTTFText($im,20,0,310,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F7"));
    ImageTTFText($im,20,0,360,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G7"));
    ImageTTFText($im,20,0,410,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H7"));
    ImageTTFText($im,20,0,460,385,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I7"));
    
    ImageTTFText($im,20,0,60,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A8"));
    ImageTTFText($im,20,0,110,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B8"));
    ImageTTFText($im,20,0,160,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C8"));
    ImageTTFText($im,20,0,210,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D8"));
    ImageTTFText($im,20,0,260,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E8"));
    ImageTTFText($im,20,0,310,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F8"));
    ImageTTFText($im,20,0,360,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G8"));
    ImageTTFText($im,20,0,410,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H8"));
    ImageTTFText($im,20,0,460,435,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I8"));
    
    ImageTTFText($im,20,0,60,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("A9"));
    ImageTTFText($im,20,0,110,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("B9"));
    ImageTTFText($im,20,0,160,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("C9"));
    ImageTTFText($im,20,0,210,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("D9"));
    ImageTTFText($im,20,0,260,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("E9"));
    ImageTTFText($im,20,0,310,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("F9"));
    ImageTTFText($im,20,0,360,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("G9"));
    ImageTTFText($im,20,0,410,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("H9"));
    ImageTTFText($im,20,0,460,485,$white,"Fonts/cambriab.ttf",$Passwordblock->where("UserID=".session("UserID"))->value("I9"));
    ////////////////////////////////////////////////////////////
    ...
    public function npdy(){
        ...
        $nbzz = $Paycost->where("UserID=".session("UserID"))->value("nbzz");
        
        if($nbzz == 0){
            
            $nbzz = $Paycost->where("UserID=0")->value("nbzz");
    ...
    public function npdycheck(){
        ...
        $UserID =$User->where("UserName='".$this->_post("UserName")."'")->value("id");
    ...
    public function npdycheckxm(){
        ...
        $Compellation = $Userbasicinformation->where("UserID=".$UserID)->value("Compellation"); 
    ...
    public function kymoney(){
        ...
        $kymoney = $Money->where("UserID=".session("UserID"))->value("Money");
    ...
    $zmoney = $Money->where("UserID=".$UserID)->value("Money");
    
    $data["Money"] = $zmoney + $this->_post("money")*$nbzz;
    
    $Money->where("UserID=".$UserID)->save($data);
    
    $cmoney = $Money->where("UserID=".session("UserID"))->value("Money");
    ...
    public function tktx(){
        ...
        $mrbank = $Bank->where("UserID=".session("UserID")." and moren = 1")->value("BankName");
        $BankAccountNumber = $Bank->where("UserID=".session("UserID")." and moren = 1")->value("BankAccountNumber");
        
         $mrbankid= $Bank->where("UserID=".session("UserID")." and banktype=0 and moren = 1")->value("id");
        ...
        $mymoney = $Money->where("UserID=".session("UserID"))->value("Money");
        
        $Usersafetyinformation =db("Usersafetyinformation");
        
        $t0 = $Usersafetyinformation->where("UserID=".session("UserID"))->value("t0");
        ...
        //每天提款次数
        $mttkcs = $Tkconfig->value("mttkcs");
        //单笔最小提款金额
        $minmoney = $Tkconfig->value("minmoney");
        //单笔最大提款金额
        $maxmoney = $Tkconfig->value("maxmoney");
        //每天最大提款金额
        $mtsxmoney = $Tkconfig->value("mtsxmoney");
        
        ////////////////////////////////////////////////////////////
        $sz = $Tkconfig->where("UserID=".session("UserID"))->value("sz");
        if($sz == 1){
           //每天提款次数
           $mttkcs = $Tkconfig->where("UserID=".session("UserID"))->value("mttkcs");
           //单笔最小提款金额
           $minmoney = $Tkconfig->where("UserID=".session("UserID"))->value("minmoney");
           //单笔最大提款金额
           $maxmoney = $Tkconfig->where("UserID=".session("UserID"))->value("maxmoney");
           //每天最大提款金额
           $mtsxmoney = $Tkconfig->where("UserID=".session("UserID"))->value("mtsxmoney");
        }
       ///////////////////////////////////////////////////////////
        ...
        //判断是否启用提款
        /////////////////////////////////////////////////////////////////////
        $tk_if = $Tkconfig->where("UserID=0")->value("tksz");
        if($tk_if == 1){
            $tkif = 0;
            $tkiflx = 1;
        }else{
            $sz = $Tkconfig->where("UserID=".session("UserID"))->value("sz");
            if($sz == 1){
                $tk_if = $Tkconfig->where("UserID=".session("UserID"))->value("tksz"); 
                if($tk_if == 1){
                    $tkif = 0;
                    $tkiflx = 1;
                }   
    ...
    public function tkjsfl(){
        ...
        $fl_money = $Tkfl->where("k_money <= ".$tkmoney." and s_money >= ".$tkmoney." and T =".$this->_post("T"))->value("fl_money");
    ...
    public function tkyhajax(){
        ...
        $BankName = $Bank->where("id=".$tkyh)->value("BankName");
        
        $BankAccountNumber = $Bank->where("id=".$tkyh)->value("BankAccountNumber");
    ...
    public function tkmoney(){
       ...
       // exit($t);
        ...
        $symoney = $Money->where("UserID=".session("UserID"))->value("Money");
        ...
        if($hjmoney <= $symoney){
            ...
            $Usersafetyinformation =db("Usersafetyinformation");
            $paypass = $Usersafetyinformation->where("UserID=".session("UserID"))->value("PayPassWord");
            if(md5($paypassword) != $paypass){
                ...
                exit("支付密码错误！");
                 ...
                 $fl_money = $Tkfl->where("k_money <= ".$tkmoney." and s_money >= ".$tkmoney." and T = ".$t)->value("fl_money");
                 ...
                 $BankName = $Bank->where("id=".$tkyhid." and UserID=".session("UserID"))->value("BankName");
                 
                 $BankBranch = $Bank->where("id=".$tkyhid." and UserID=".session("UserID"))->value("BankBranch");

                 $BankAccountNumber = $Bank->where("id=".$tkyhid." and UserID=".session("UserID"))->value("BankAccountNumber"); 
                 
                 $BankCompellation = $Bank->where("id=".$tkyhid." and UserID=".session("UserID"))->value("BankCompellation");   
                 
                 $zhihang = $Bank->where("id=".$tkyhid." and UserID=".session("UserID"))->value("zhihang");
                 ...
                 if($this->_post("wtwt") != 1){
                   ...
                   //////////////////////////////////////////////////////////
                   $Tkconfig =db("Tkconfig");
      $femail = $Tkconfig->where("UserID=0")->value("Email");             
                     ...
                     if($Tklistid){
                         ...
                         if($Money->where("UserID=".session("UserID"))->save($data)){
                             ...
                             foreach($arraylist as $val){
                                 //echo $val;
                               $BankName = $Bank->where("id=".$val)->value("BankName");                            
                                $BankBranch = $Bank->where("id=".$val)->value("BankBranch");
                                $BankAccountNumber = $Bank->where("id=".$val)->value("BankAccountNumber");     
                                $BankCompellation = $Bank->where("id=".$val)->value("BankCompellation"); 
                                $zhihang = $Bank->where("id=".$val)->value("zhihang");
    ...
    public function wttk(){
       ...
       ///////////////////////////////////////////////////////////
        ...
        $yqlmoney = $Tklist->where("DATEDIFF(now(),sq_date) = 0 and UserID = ".session("UserID"))->sum("tk_money");
         ...
         //判断是否启用提款
        /////////////////////////////////////////////////////////////////////
        $tk_if = $Tkconfig->where("UserID=0")->value("wttksz");
        if($tk_if == 1){
            $tkif = 0;
            $tkiflx = 1;
        }else{
            $sz = $Tkconfig->where("UserID=".session("UserID"))->value("sz");
            if($sz == 1){
                $tk_if = $Tkconfig->where("UserID=".session("UserID"))->value("wttksz"); 
                if($tk_if == 1){
                    $tkif = 0;
                    $tkiflx = 1;
                }else{
                    $User =db("User");
                    $gmwttk = $User->where("id=".session("UserID"))->value("gmwttk");
...
$contents=fread($contents,4096); 
     ...
     public function tzshow($TransID){
      ...
      public function wtplxf(){  //委托批量下发
            ...
            $tjlnf = $Tkconfig->where("UserID=0")->value("wtplxfnf");
      ...
      public function wtplxfok(){
        ...
        $tjlnf = $Tkconfig->where("UserID=0")->value("wtplxfnf");  //T+0年费
    ...
    public function sqzdjs(){
        ...
        $tjlnf = $Tkconfig->where("UserID=0")->value("zdtknf");
    ...
    public function zdjsok(){
        ...
        $tjlnf = $Tkconfig->where("UserID=0")->value("zdtknf");  //T+0年费
    ...
    public function skym(){
        ...
        $User =db("User");
        $mypayurlname = $User->where("id=".session("UserID"))->value("mypayurlname");
        $if = 0;
        $weburl = "";
        if($mypayurlname){
               $if = 1;
    ...
    public function addskym(){
         ...
         $User =db("User");
         $UserID = $User->where("mypayurlname='".$mypayurlname."'")->value("id");
         if($UserID){
             exit("1");
         }
...
public function mypay(){
      header("Content-Type:text/html; charset=utf-8"); 
      $Userapiinformation =db("Userapiinformation");
      $keykey = $Userapiinformation->where("UserID=".session("UserID"))->value("key");   
   ...
   public function xgjk(){
       ...
       $System =db("System");
       $mrapiid = $System->where("UserID=0")->value("DefaultBank");
       $mrapiname = $Sjapi->where("id=".$mrapiid)->value("myname");
       
       $Usersafetyinformation =db("Usersafetyinformation");   
       $myapiid = $Usersafetyinformation->where("UserID=".session("UserID"))->value("PayBank");
       if(intval($myapiid) == 0){
           $myapiname = $mrapiname;
       }else{
           $myapiname = $Sjapi->where("id=".$myapiid)->value("myname");
       }
   ...
   public function xgjkedit(){
      ...
      public function EditFl(){
       $id = $this->_get("id");
       $User =db("User");
       $xjUserName = $User->where("id=".$id)->value("UserName");
       
       $Paycost =db("Paycost");
       $fl = $Paycost->where("UserID=".$id)->value("wy");
       $sjfl = $Paycost->where("UserID=".session("UserID"))->value("wy");
       
       if($sjfl == 0){
           $sjfl = $Paycost->where("UserID=0")->value("wy");
       }
       
        if($fl == 0){
           $fl = $Paycost->where("UserID=0")->value("wy");
       }
   ...
   public function EditFlEdit(){
       ...
       public function cxjlxj(){
          ...
          $UserName = $User->where("id=".$this->_get("id"))->value("UserName");
       ...
       $Paycost =db("Paycost");
        ...
        $fl = $Paycost->where("UserID=".$this->_get("id"))->value("wy");
